...
@implementation RevisionEpisodeMenu
...
- (id)initWithShowId:(NSString *)sId
{
    ...
    if (self) {
        ...
        [self setListIcon:[BRImage imageWithPath:[[NSBundle bundleForClass:[RevisionEpisodeMenu class]] pathForResource:@"Revision3_Icon" ofType:@"png"]] horizontalOffset:0.0f kerningFactor:0.0f];
         
//        //Needed? If so, release it before setting a new one after parsing the JSON
//        dataList = [[NSMutableArray alloc] init];
        
        NSString *mediaSource;
        if([showId isEqualToString:@"-1"]){
            mediaSource = @"http://revision3.com/api/getEpisodes.json?offset=0&limit=25&grouping=latest&version=1.0.1&api_key=0b1faede6785d04b78735b139ddf2910f34ad601";
        } else {
            mediaSource = [NSString stringWithFormat:@"http://revision3.com/api/getEpisodes.json?offset=0&limit=25&show_id=%@&grouping=by_show&version=1.0.1&api_key=0b1faede6785d04b78735b139ddf2910f34ad601", showId];
        }
