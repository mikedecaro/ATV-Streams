...
- (id)initWithShowId:(NSString *)sId
{
    ...
    if (self) {
        ...
        [self setListIcon:[BRImage imageWithPath:[[NSBundle bundleForClass:[CrackleEpisodeMenu class]] pathForResource:@"Crackle" ofType:@"png"]] horizontalOffset:0.0f kerningFactor:0.0f];
